...
@Composable
fun IngredientEven(ingredient: IngredientModel) {
    Card(
        modifier = Modifier.fillMaxWidth().background(Back2).padding(5.dp)) {
        Row(modifier = Modifier.fillMaxWidth().defaultMinSize(minHeight = 50.dp).background(Back2)

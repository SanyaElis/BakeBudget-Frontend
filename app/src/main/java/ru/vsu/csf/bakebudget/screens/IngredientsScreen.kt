                            ...
                            if (ingredientsResponse.isEmpty()) {
                                item {
                                    Box(modifier = Modifier.padding(16.dp)) {
                                        Text(
                                            text = "Это страница ингредиентов. \nЗдесь вы можете добавлять, редактировать и удалять ингредиенты, которые вы сможете использовать в своих изделиях! \nЧтобы добавить ингредиент, нажмите кнопку «ДОБАВИТЬ» в нижней панели. \nДля редактирования и удаления ингредиентов, нажмите на 3 точки справа от нужного ингредиента.",
                                            fontSize = 18.sp,
